...
switch ($_POST['req']) {
  ...
  case "show":
    ...
    <table id="cart-table">
      ...
      <tr>
        ...
        <td><strong><?= sprintf("Rs%0.2f", $total) ?></strong></td>
      </tr>
    </table>
  ...
  case "checkout-email":
    ...
    if ($cartLib->checkout() {
      ...
      $message = "Your order has been received.You will be notified soon about the delivery.";
      ...
      $headers = implode("\r\n", [
        ...
        'From: karthikaaamanoj@gmail.com'
      ]);
